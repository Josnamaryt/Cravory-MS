...
?>
 <?php 
    ...
    $return_reg_details="SELECT * FROM `user_credential_reg` WHERE u_id='$u_id'" ;
                ...
                <div class="container-fluid">
                    ...
                    <span class="navbar-toggler-icon"></span>
                        ...
                        <div class="collapse navbar-collapse" id="navbarNav">
                            <ul class="navbar-nav">
                                <li class="nav-item">
                                    <a class="nav-link" href="userorder.php"><b>Order</a></b>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="feedback.html"><b>Feedback</a></b> 
                                </li>
                            </ul>
                        </div>
                        <img class="prfile_image" src="./uploads/<?php echo $u_img;?>" alt="Logo" style="width: 51;  border-radius: 50%;transition: transform .5s;transform: scale(1);margin-right: 4px;"> 
                        <button type="button" class="btn btn-outline-secondary" data-bs-toggle="collapse" data-bs-target="#collapseWidth" aria-expanded="false" aria-controls="collapseWidth"><b><?php echo $row['u_name'] ?></b></button>
                </div>
            </nav>
